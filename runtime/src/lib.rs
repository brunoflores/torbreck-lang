  ...
  pub fn interpret(&mut self) {
    ...
    loop {
      ...
      match self.decode() {
        ...
        Instruction::Atom0 => self.accu = Value::Header(self.first_atoms[0]),
        Instruction::Atom1 => self.accu = Value::Header(self.first_atoms[1]),
        Instruction::Atom2 => self.accu = Value::Header(self.first_atoms[2]),
        Instruction::Atom3 => self.accu = Value::Header(self.first_atoms[3]),
        Instruction::Atom4 => self.accu = Value::Header(self.first_atoms[4]),
        Instruction::Atom5 => self.accu = Value::Header(self.first_atoms[5]),
        Instruction::Atom6 => self.accu = Value::Header(self.first_atoms[6]),
        Instruction::Atom7 => self.accu = Value::Header(self.first_atoms[7]),
        Instruction::Atom8 => self.accu = Value::Header(self.first_atoms[8]),
        Instruction::Atom9 => self.accu = Value::Header(self.first_atoms[9]),
        Instruction::Atom => {
          self.step(None);
          let valofpc = self.mem[self.pc as usize];
          self.accu = Value::Header(self.first_atoms[valofpc as usize]);
        }
